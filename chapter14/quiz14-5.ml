...
let rec count_A lst =
  let is_A gakusei_t = gakusei_t.seiseki = "A" in
...
let gakusei_sum lst =
  let add_gakusei_score gakusei rest_score = gakusei.tensuu + rest_score in
  fold_right add_gakusei_score lst 0 
...
let rec append lst1 lst2 =
  let append_single first lst = first :: lst
  in fold_right append_single lst1 lst2
